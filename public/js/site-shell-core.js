...
import { publicNavigationItems } from './public-navigation.js?v=20260822-drawer-unified-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import {
  identityProfileUrl,
...
/* =========================================================
   ...
   USO na página:
     ...
     import { initSiteShell } from './js/site-shell.js?pgv=82901afbc8df';
