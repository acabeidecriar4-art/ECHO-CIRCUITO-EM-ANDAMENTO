...
if (pageKey === 'home') {
  import('./public-navigation.js?v=20260822-drawer-unified-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df')
...
if (pageKey === 'heroes' || pageKey === 'equipments') {
  import('./site-shell-route-sync.js?v=20260822-guides-private-1&pgv=82901afbc8df').catch(error => {
    console.warn('[site-shell-route-sync] Não foi possível sincronizar as rotas da navegação.', error);
  });
}

if (pageKey === 'build_creator') {
  import('./build-external-data-ui.js?v=5&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df').catch(error => {
