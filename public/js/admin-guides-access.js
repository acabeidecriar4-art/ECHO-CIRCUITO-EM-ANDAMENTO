...
import {
  getAdminProfile,
  getRoleName
} from '../admin/js/admin-auth.js?v=20260822-post-main-audit-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
...
async function loadAuthorizedExperience() {
  await import('./site-content.js?v=20260822-drawer-unified-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
  await import('./public-modules.js?v=20260822-drawer-unified-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
  await import('./public-modules-polish.js?v=20260823-public-modules-freeze-hotfix-1&pgv=82901afbc8df');
  await import('./editorial-seo.js?v=1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
  await import('./module-public-shell.js?v=20260822-beta-module-4&active=guias&sb=20260823-security-supabase-pin-1&identity=20260825-v6-public-1&pgv=82901afbc8df');
}
