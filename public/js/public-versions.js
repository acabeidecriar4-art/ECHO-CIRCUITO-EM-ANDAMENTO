...
import './public-beta-banner.js?v=20260830-release-060-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { PUBLIC_RELEASE_MANIFEST } from './public-release-manifest.js?v=20260830-release-060-1&pgv=82901afbc8df';
...
async function load() {
  ...
  if (current) current.textContent = CODE_VERSION.toUpperCase();
  if (status) {
