import * as audit from './build-analise-audit-core.js?v=4&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';

export * from './build-analise-audit-core.js?v=4&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
...
function compatibleWithLiveHero(item, slotKey) {
  ...
  if (item.heroId && String(item.heroId) !== String(liveContext.heroi.databaseId)) return false;
  if (item.classId && String(item.classId) !== String(liveContext.heroi.classId || '')) return false;
  return true;
}
...
function ensurePublicCounterfactualUi() {
  ...
  if (!publicUiPromise) {
    publicUiPromise = import('./criar-build-counterfactual.js?v=1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df')
