import { requireAdmin, logoutAdmin } from '../admin/js/admin-auth.js?v=20260822-post-main-audit-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { listHeroes, deleteHero, setHeroEnabled } from './api.js?v=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { getPublicMediaUrl, removeGameMedia } from './admin-media.js?v=20260823-security-supabase-pin-1&pgv=82901afbc8df';
