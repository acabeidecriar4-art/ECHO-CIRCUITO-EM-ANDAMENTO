...
function renderProfile(data){
  ...
  $('profile-name').textContent=identity.display_name||identity.public_handle||'Jogador';
  $('profile-handle').textContent=identity.public_handle?`@${identity.public_handle}`:'';
  $('profile-bio').textContent=identity.bio||'Sem bio pública.';
  ...
  renderPersonalAccent(identity);
  renderAuthority(visual);
  renderBadges(identity);
