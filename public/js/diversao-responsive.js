...
await import('./diversao-runtime-guard-v19.js?v=20260827-diversao-audit-v19-1&pgv=82901afbc8df');

const qaEnabled = new URLSearchParams(location.search).has('qa') || window.parent !== window;
if (qaEnabled) await import('./diversao-qa-isolated-v21.js?v=20260827-diversao-ios-isolation-v21-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
