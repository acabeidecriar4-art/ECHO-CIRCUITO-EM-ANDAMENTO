...
import { requireAdmin } from './admin-auth.js?v=20260823-security-mfa-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { initAdminAuditAwareness } from './admin-audit-awareness.js?v=20260822-admin-nav-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
...
async function initContextModules(){
  ...
  try{
    const module=await import('./hero-skills-panel.js?v=20260830-skills-community-audit-1&pgv=82901afbc8df');
