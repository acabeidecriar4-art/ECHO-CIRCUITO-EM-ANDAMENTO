import {
  requireAdmin,
  logoutAdmin
} from './admin-auth.js?v=20260823-security-supabase-pin-1&pgv=82901afbc8df';
...
import {
  ...
  saveEquipmentBundle,
  upsertSet
} from './equipment-api.js?v=brain-evolution-3&av2=20260828&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';

import {
  uploadEquipmentImage,
  publicMediaUrl
} from './equipment-media.js?v=20260823-security-supabase-pin-1&pgv=82901afbc8df';
    ...
    try {
      ...
      const savedEquipment =
        await saveEquipmentBundle({
          ...
          replaceBonuses: true,
          auditSource: importWasApplied ? 'image-or-json-import' : 'admin-editor'
        });
