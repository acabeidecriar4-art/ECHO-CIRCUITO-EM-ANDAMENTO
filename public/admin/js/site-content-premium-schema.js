import { SITE_CONTENT_PAGES as EDITOR_SITE_CONTENT_PAGES } from '../../js/site-content-schema.js?v=9&pgv=82901afbc8df';
...
await import('./site-content-premium-schema-core.js?v=20260822-admin-public-sync-3&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
await import('./heroes-overview-schema.js?v=20260829-heroes-admin-schema-2&pgv=82901afbc8df');
await import('./site-content-final-sync.js?v=20260822-admin-public-sync-3&pgv=82901afbc8df');

const { SITE_CONTENT_PAGES: EXTENDED_SITE_CONTENT_PAGES } = await import('../../js/site-content-schema.js?v=8&pgv=82901afbc8df');
