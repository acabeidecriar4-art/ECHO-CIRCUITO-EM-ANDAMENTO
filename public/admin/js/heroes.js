import {
  ...
  deleteHero,
  setHeroEnabled
} from '../../js/api.js?v=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { getPublicMediaUrl, removeGameMedia } from '../../js/admin-media.js?v=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import {
  loadHeroPublicParityData,
  mergeHeroPublicState
} from './heroes-public-parity.js?v=20260821-admin-experience-2&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
...
function injectPublicationStyles() {
  ...
  style.textContent = `
    ...
    .hero-readiness-badge.block{border-color:#71303b;background:#2a1016;color:#ff9aaa}
    ...
    <article class="hero-card" data-hero-id="${escapeHtml(hero.id)}">
      ...
      <div class="hero-card-body">
        ...
        <div class="hero-card-actions">
          ...
          <a class="admin-button public-preview" data-public-preview href="../herois.html?heroi=${encodeURIComponent(hero.slug || '')}" target="_blank" rel="noopener">Ver público</a>
