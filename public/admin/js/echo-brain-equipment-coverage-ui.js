import { listEquipments, getEquipmentBundle } from './equipment-api.js?v=brain-evolution-3&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { auditEquipmentBundlesCoverageV1 } from '../../js/echo-brain-equipment-coverage-v1.js?v=1&pgv=82901afbc8df';
...
function renderAudit(audit) {
  ...
  host.innerHTML = `
    <div class="invest-card">
      ...
      <p>Leitura somente do banco atual. O diagnóstico usa o mesmo <code>applyEquipmentStats()</code>, o mesmo item-fit semântico e o mesmo grafo do Echo Brain; não possui tabela paralela de regras.</p>
      <div class="invest-grid">
        <div><span>Equipamentos</span><b>${n(audit.bundlesScanned)}/${n(audit.equipmentsExpected)}</b><small>bundles lidos</small></div>
        <div><span>Mapeamentos numéricos</span><b>${n(audit.numericMappings)}</b><small>calculáveis</small></div>
...
async function auditLiveCatalog() {
  ...
  try {
    ...
    const audit = auditEquipmentBundlesCoverageV1(bundles.filter(Boolean));
