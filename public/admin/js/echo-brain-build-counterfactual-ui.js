...
import { getEquipmentBundle, listEquipments } from './equipment-api.js?v=brain-evolution-3&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { carregarDadosAnalise, analisarBuildComAutoridadeV4 } from '../../js/build-analise.js?v=16&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import { evaluateEquipmentSwapCounterfactualsV1 } from '../../js/echo-brain-build-counterfactual-v1.js?v=1&pgv=82901afbc8df';
...
function compatible(equipment, hero) {
  ...
  if (equipment.hero_id) return String(equipment.hero_id) === String(hero.id);
  if (equipment.class_id) return String(equipment.class_id) === String(hero.class_id);
  return true;
}
