import { loadEquipmentBrainHealth, equipmentBrainHealthCopy } from './echo-brain-equipment-health.js?v=1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
import {
  bootstrapEquipmentBrainKnowledge,
  reconcileEquipmentBrainQueue
} from './echo-brain-equipment-reconcile.js?v=1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df';
...
try {
  await import('./echo-brain-investigation-ui.js?v=20260824-brain-investigation-2&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
  await import('./echo-brain-build-counterfactual-ui.js?v=20260828-zeptolab-damage-2&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
  await import('./echo-brain-equipment-coverage-ui.js?v=20260823-brain-coverage-1&sb=20260823-security-supabase-pin-1&pgv=82901afbc8df');
} catch (error) {
